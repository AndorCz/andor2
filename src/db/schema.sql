...
create table board_poll_votes (
  ...
  created_at timestamp with time zone default current_timestamp,
  constraint board_poll_votes_profile_fkey foreign key (profile_id) references profiles(id) on delete cascade,
  constraint board_poll_votes_unique unique (poll_id, profile_id)
);

create index board_poll_votes_poll_id_idx on board_poll_votes (poll_id);
