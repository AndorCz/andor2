...
export const baseStoryteller = {
  ...
  goal: `Tvým cílem je postupně utvářet zajímavý a uvěřitelný příběh, který budou hráči moci prožívat a dělat vlastní rozhodnutí o svých postavách.
    ...
    Vždy piš na kvalitní literární úrovni a v češtině (včetně názvů a jmen, pokud to není stylistický záměr).
...
export const baseAssistant = {
  ...
  goal: `Tvým cílem je připravit podklady pro zajímavý a uvěřitelný příběh.
    Vždy piš na kvalitní literární úrovni a v češtině (včetně názvů a jmen, pokud není v daném případě stylistickým záměrem použít cizí jazyk).
    Výstup formátuj pomocí jednoduchého HTML, s <h2> jako hlavními nadpisy.
