...
export const illustrationStyleAffixes = {
  rpg: 'Detailed black ink RPG book illustration on texture of aged parchment. Artwork rendered with fine linework, hatching, and cross-hatching. No coloring, absolutely NOT anime, NOT manga, NOT cartoon. Faces must be realistic, drawn in traditional Western pen-and-ink RPG style.',
  anime: 'Detailed pastel colored anime styled illustration.',
  realistic: 'Detailed, colored, realistic digital art illustration, like concept art for AAA games or ArtStation.'
}
