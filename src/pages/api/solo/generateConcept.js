    ...
    await Promise.race([
      ...
      (async () => {
        ...
        if (generating.includes('generated_world')) {
          ...
          const { data } = await locals.supabase.from('solo_concepts').select('generated_world').eq('id', id).single()
          responseWorld = { text: data.generated_world }
        }
        ...
        if (generating.includes('generated_factions')) {
          ...
          const { data } = await locals.supabase.from('solo_concepts').select('generated_factions').eq('id', id).single()
          responseFactions = { text: data.generated_factions }
        }
        ...
        if (generating.includes('generated_locations')) {
          ...
          const { data } = await locals.supabase.from('solo_concepts').select('generated_locations').eq('id', id).single()
          responseLocations = { text: data.generated_locations }
        }
        ...
        if (generating.includes('generated_characters')) {
          ...
          const { data } = await locals.supabase.from('solo_concepts').select('generated_characters').eq('id', id).single()
          responseCharacters = { text: data.generated_characters }
        }
        ...
        if (generating.includes('generated_protagonist')) {
          ...
          const { data } = await locals.supabase.from('solo_concepts').select('generated_protagonist').eq('id', id).single()
          responseProtagonist = { text: data.generated_protagonist }
        }
